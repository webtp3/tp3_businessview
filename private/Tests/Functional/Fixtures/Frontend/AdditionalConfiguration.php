...
if (TYPO3_MODE === 'FE') {
    $GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['tslib/class.tslib_fe.php']['initFEuser']['FunctionalTest'] =
        \CAG\CagTests\Core\Functional\Framework\Frontend\Hook\FrontendUserHandler::class . '->initialize';
    $GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['tslib/index_ts.php']['postBeUser']['FunctionalTest'] =
        \CAG\CagTests\Core\Functional\Framework\Frontend\Hook\BackendUserHandler::class . '->initialize';
}
