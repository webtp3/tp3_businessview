#
# Table structure for table 'tx_tp3parallax_domain_model_section'
#
CREATE TABLE tx_tp3parallax_domain_model_section (
	...
	parallaxcollection int(11) unsigned DEFAULT '0',
