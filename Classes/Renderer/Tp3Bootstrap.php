<?php
namespace Tp3\Tp3Businessview\Renderer;
...
$ajax['arguments']	= $_gp;
$ajax['vendor'] 	= 'Tp3';
$ajax['extensionName'] 	= 'Tp3Businessview';
$ajax['pluginName'] 	= 'Tp3Businessview';
$ajax['controller'] 	= 'Tp3BusinessView';
//prevent injection of action
$ajax['action'] 	= $_gp["eID"] == "create" ? "create" : "edit";
/**
