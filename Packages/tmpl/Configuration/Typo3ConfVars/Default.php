...
return [
    'SYS' => [
        'errorHandler' => \CAG\Tmpl\Error\ErrorHandler::class,
        'productionExceptionHandler' => \CAG\Tmpl\Error\ProductionExceptionHandler::class,
        'debugExceptionHandler' => \CAG\Tmpl\Error\DebugExceptionHandler::class,
