 ...
 */
class CollectionsControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
    /**
     * @var \Tp3\Tp3Parallax\Controller\CollectionsController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\Tp3\Tp3Parallax\Controller\CollectionsController::class)
    ...
    public function listActionFetchesAllCollectionssFromRepositoryAndAssignsThemToView()
    {
        ...
        $collectionsRepository = $this->getMockBuilder(\Tp3\Tp3Parallax\Domain\Repository\CollectionsRepository::class)
            ->setMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $collections = new \Tp3\Tp3Parallax\Domain\Model\Collections();
