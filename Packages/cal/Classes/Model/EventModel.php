...
class EventModel extends \TYPO3\CMS\Cal\Model\Model
{
    ...
    public function getHeaderStyle()
    {
        ...
        } elseif (count($this->categories) && is_object($this->categories [0])) {
                    ...
                    case 'start':
                        {
                            if ($user_uid > 0) {
                                ...
                                if (($captchaStr && $this->controller->piVars ['captcha'] === $captchaStr) || ($this->conf ['subscribeWithCaptcha'] == 0)) {
                                    ...
                                    $local_switch ['###CONFIRM_LINK###'] = GeneralUtility::getIndpEnv('TYPO3_SITE_URL') . $this->controller->pi_getPageLink($this->conf ['view.'] ['event.'] ['notify.'] ['subscriptionViewPid'], '', [
                                    ...
                                    $local_switch ['###EVENT_LINK###'] = GeneralUtility::getIndpEnv('TYPO3_SITE_URL') . $this->controller->pi_getPageLink($this->conf ['view.'] ['event.'] ['eventViewPid'], '', [
